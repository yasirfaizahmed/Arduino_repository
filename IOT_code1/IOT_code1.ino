...
char aws_endpoint[]    = "alua1a3utnw2u-ats.iot.ap-southeast-1.amazonaws.com";//HTTPS
char aws_key[]         = "AKIAZ34DNC6SZI4QCPPV";//from credential file
char aws_secret[]      = "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";//from credential file
char aws_region[]      = "ap-southeast-1";// from the url
const char* aws_topic  = "$aws/things/IOTMESTY/shadow/update";//from MQTT>things shadow
int port = 443;
